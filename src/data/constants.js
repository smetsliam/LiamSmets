...
export const PROJECTS = [
...

  {
    ...
    title: 'Lorem ipsum dolor sit amet',
    description:
      'periri euripidis qui ea, mea te nihil nemore praesent, in quo menandri platonem. Erat luptatum an eos, clita aliquip tractatos id est. Aliquip iuvaret percipit eu nam, enim euismod his et. Ipsum menandri eam ad, ut sed regione interpretaris. Eros exerci scriptorem eu mei. Et sonet graeci quo. Viris volutpat eos ea, qui te volumus lucilius, cibo qualisque ex usu',
    image: '/placeholder.png',
    gitUrl: 'https://github.com/',
    previewUrl: 'https://www.google.com/',
  },
  ...
  },
  {
    ...
    title: 'Lorem ipsum dolor sit amet',
    description:
      'Usu cu tantas utroque senserit, mel alterum commune instructior an. Sit tractatos concludaturque eu, ad solet voluptatibus mea, vim cu sonet omnes. Esse errem gubergren eam ex, vidisse apeirian reprehendunt te per, altera aliquando per cu. Unum error suavitate eam ea, illud altera doctus vis ea. Per corrumpit vituperatoribus et. Solet tincidunt nec id, at purto melius instructior per, te vix numquam eleifend.',
    image: '/placeholder.png',
